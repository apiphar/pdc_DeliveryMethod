...
export class AfiReturnToOutletRevisiFormController implements angular.IController {
    $inject = ['AfiReturnToOutletRevisiFormService','$rootScope'];
    ...
    kabupaten: any;
    regionAfiData: any;
    dataInsert: Component.DataInsertRORevisiModel;
    url: string;
    ...
    $onInit() {
        this.$rootScope.$on("ReturnToOutletRevisi", (event, result) => {
    ...
    initialForm(result: any) {
        this.dataInsert = new DataInsertRORevisiModel();
    ...
    updateData(myForm: angular.IFormController) {
        ...
        this.AfiReturnToOutletService.UpdateAFIRevisi(this.dataInsert).then(response => {
            this.kembali(myForm);
...
export class AfiReturnToOutletRevisiForm implements angular.IComponentOptions {
    controller = AfiReturnToOutletRevisiFormController;
    controllerAs = 'me';

    template =  require('./AfiReturnToOutletRevisiForm.html');
}


export class DataInsertRORevisiModel {
    revisi?: number;
